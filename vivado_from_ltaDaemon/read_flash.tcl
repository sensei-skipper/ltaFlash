# Read the connected LTA's flash, writes contents to readback.mcs in the current directory. After this is run, you must power-cycle the LTA to reboot from flash.
...
#set_property PROGRAM.FILES [list "memory.mcs" ] [ get_property PROGRAM.HW_CFGMEM [current_hw_device]]
#set_property PROGRAM.PRM_FILE {memory.prm} [ get_property PROGRAM.HW_CFGMEM [current_hw_device]]

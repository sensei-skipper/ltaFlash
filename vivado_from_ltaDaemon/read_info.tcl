# Read the connected LTA's flash info, writes contents to readback_info.mcs in the current directory. After this is run, you must reboot the LTA from flash.
